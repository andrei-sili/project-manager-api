  ...
  return (
      <>
        <div className="mt-8 grid md:grid-cols-3 gap-5">
          ...
          {/* Files and Activity sections unchanged */}
          ...
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div>
              <div className="mb-2">
                ...
                <span
                    className={`inline-block px-2 py-1 rounded text-white text-xs font-bold ${task.status === "done"
                        ? "bg-green-700"
              ...
              <div className="mb-2">
                ...
                <span
                    className={`inline-block px-2 py-1 rounded text-xs font-bold ${task.priority === "high"
