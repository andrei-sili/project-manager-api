...
//       // AuthProvider.login() will redirect on success
//     } catch (e: any) {
...
//             <label
//               htmlFor="email"
//               className="block text-zinc-300 text-sm font-medium mb-1"
//             >
//               Email
//             </label>
//             <input
...
//           {/* Future: <Link href="/register" className="ml-1 text-blue-400 hover:underline">Sign up</Link> */}
//         </div>
//       </div>
//     </div>
//   );
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-tr from-zinc-800 to-zinc-900">
      <div className="w-full max-w-md p-8 bg-zinc-900 rounded-2xl shadow-2xl border border-zinc-800">
        <div className="flex justify-center mb-6">
          {/* Logo SVG */}
          <svg width="44" height="44" fill="none" className="text-blue-400" viewBox="0 0 48 48">
            <rect width="48" height="48" rx="10" fill="#3b82f6" opacity="0.15" />
            <path
              d="M14 30v-8a10 10 0 0120 0v8"
              stroke="#3b82f6"
